...
<body>
  ...
  <div id="popupLogin">
    ...
    <form action="" method="POST">
      <input type="text" placeholder="E-mail" size="45" id="campoEmaillogin" name="email">
      <input type="password" placeholder="Senha" size="45" id="campoSenha" name="senha">
      <button type="submit" id="btnSingin">SING IN</button>
      <a onclick="abrirCriarConta()" id="btnCriarConta">Criar conta</a>
    </form>
  </div>
  <div id="popupEsqSenha">
    <p id="txtRedefinir">Redefina sua senha</p>
    <p id="txtEnviaremos">Enviaremos um e-mail para redefinir a sua senha</p>
    <input type="text" placeholder="E-mail" size="45" id="campoEmailRedfSenha">
    <a href="" id="btnEnviarRedSenha"> ENVIAR</a>
    <a href="" id="btnCancelar">
      <center>Cancelar</center>
    </a>
  </div>
  <div id="popupCriarConta">
    <p id="txtCriarConta">Criar Conta</p>
    <form action="" method="POST">
      <input type="text" placeholder="Nome" size="45" id="campoEmaillogin" name="nome">
      <input type="text" placeholder="Sobrenome" size="45" id="campoEmaillogin" name="sobrenome">
      <input type="text" placeholder="cpf" size="45" id="campocpf" name="cpf">
      <input type="text" placeholder="Telefone" size="45" id="campotelefone" name="telefone">
      <input type="text" placeholder="E-mail" size="45" id="campoEmaillogin2" name="email2">
      <input type="password" placeholder="Senha" size="45" id="campoSenhaCriar2" name="senha2">
      <center><button type="submit" id="btnCriar">Criar</a></center></button>
    </form>
    <a id="btnJaConta" onclick="abrirLoginNovamente()">
      <center>Já tem conta?</center>
</a>
  </div>
  ...
  <div class="footer-basic">
    <footer>
      ...
      <ul class="list-inline">
        <li class="list-inline-item"><a href="site.php">Página principal</a></li>
