...
if (isset($_POST['cor'])) {
  ...
  $sql_code = "UPDATE `variaveis` SET `qnt_estoque` = `qnt_estoque`-1 WHERE `variaveis`.`cor` = '$cor' and `id_produto` = '5'";
  $sql_query = $mysqli->query($sql_code) or die("Falha na execução do código SQL: " . $mysqli->error);
  $sql_code2 = "INSERT INTO `pedidos` (`id_cliente`, `id_produto`, `data_entrega`, `quantidade`) VALUES ('$_SESSION[id_cliente]', '5', '' , '1') ";
  ...
  <main class="main">
    <div class="campo1">
      <div class="bordaProduto">
        <img class="imgProduto" src="http://localhost/ecommerce/img/saco_de_dormir.jpg" alt="Imagem do produto" /><br />
      </div>
      ...
      <p class="infoProduto sobreProduto">
        ...
        <br><br>
        Saquinho de dormir suuuper quentinho, ideal para levar para maternidade, onde o recém nascido precisa se manter acolhido fora do útero.
        Além disso, é bem mais prático que as mantas tradicionais de maternidade, só colocar seu filhote dentro e fechar com ziper. Quer coisa mais prática?!
        E depois você ainda pode usar quando ele estiver maiorzinho, como cobertor, só abrir o zíper até o final.
        <br><br>
        <strong>Especificações:</strong>
        <br><br>
        Tecido: Interior em algodão liso e exterior em poliester
        <br>
        Tamanho: único
      </p>
      <hr>
    ...
    <div class="campo2">
      <h1>Saco de dormir ultra macio</h1>
      <h2>R$175,00</h2>
      <form method="post">
        <p class="tamanhoProduto">Tamanho: </p>
        <br /><input class="checkboxTamanhoP separar" type="radio" name="cor" value="azul" />azul
        <input class="checkboxTamanhoP separar" type="radio" name="cor" value="vermelho" />Vermelho

        <div>
          <br>
          <p class="msgEstoque">Estoque Disponível: 20 unidades disponíveis</p>
        </div>
        <a href="https://mpago.la/1GMRuKf"><input type="submit" name="btnSubmiti" value="COMPRAR AGORA" class="botao comprar"></a>
