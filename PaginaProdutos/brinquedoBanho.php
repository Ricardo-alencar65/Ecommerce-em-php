...
if (isset($_POST['cor'])) {
  ...
  $sql_code = "UPDATE `variaveis` SET `qnt_estoque` = `qnt_estoque`-1 WHERE `variaveis`.`cor` = '$cor' and `id_produto` = '8'; ";
  $sql_query = $mysqli->query($sql_code) or die("Falha na execução do código SQL: " . $mysqli->error);
  $sql_code2 = "INSERT INTO `pedidos` (`id_cliente`, `id_produto`, `data_entrega`, `quantidade`) VALUES ('$_SESSION[id_cliente]', '8', '' , '1') ";
  ...
  <main class="main">
    <div class="campo1">
      <div class="bordaProduto">
        <img class="imgProduto" src="http://localhost/ecommerce/img/brinquedoBanho.jpg" alt="Imagem do produto" /><br />
      </div>
      ...
      Descrição: Brinquedo lúdico, ótimo para distrair o bebê enquanto toma o banho de banheira. Feito em plástico, livre de toxinas.
        <br><br>
        <strong>Modo de Uso: </strong>
        1º passo: Encher o ovinho com água para que o bichinho apareça
        <br>
        2º passo: Deixar a água fluir pelos buraquinhos para que o bichinho entre no ovinho.
        <br>
        3º passo: Apertando a cabeça do bichinho esguichará água da boca.
        <br><br>
        <strong>Medidas:  </strong>
        <br>
        Tamanho: 10cm x 9,5 cm x 9,5 cm (aprox.)
        <br><br>
        <strong>Faixa etária:</strong> Até 4 anos.
      </p>
      <hr>
      <div class="avaliacao">
        <h3>
    ...
    <div class="campo2">
      <h1>Brinquedo de banho ovinho</h1>
      <h2>R$89,00</h2>
      <form method="post">
        <p class="tamanhoProduto">Cor: </p>
        <br /><input class="checkboxTamanhoP separar" type="radio" name="cor" value="preto" />Preto
        <input class="checkboxTamanhoP separar" type="radio" name="cor" value="amarelo" />Amarelo

        <div>
          <br>
          <p class="msgEstoque">Estoque Disponível: 20 unidades disponíveis</p>
        </div>
        <a href="https://mpago.la/13wNqD8"><input type="submit" name="btnSubmiti" value="COMPRAR AGORA" class="botao comprar"></a>
