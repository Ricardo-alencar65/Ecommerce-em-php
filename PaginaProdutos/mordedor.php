...
if (isset($_POST['cor'])) {
  ...
  $sql_code = "UPDATE `variaveis` SET `qnt_estoque` = `qnt_estoque`-1 WHERE `variaveis`.`cor` = '$cor' and `id_produto` = '2'; ";
  $sql_query = $mysqli->query($sql_code) or die("Falha na execução do código SQL: " . $mysqli->error);
  $sql_code2 = "INSERT INTO `pedidos` (`id_cliente`, `id_produto`, `data_entrega`, `quantidade`) VALUES ('$_SESSION[id_cliente]', '2', '' , '1') ";
  ...
  <main class="main">
    <div class="campo1">
      <div class="bordaProduto">
        <img class="imgProduto" src="http://localhost/ecommerce/img/mordedorAlt.jpg" alt="Imagem do produto" /><br />
      </div>
      ...
      <p class="infoProduto sobreProduto">
        Mordedor feito de madeira natual e silicone.
        Mordedor seguro para a dentição e livre de produtos químicos.
        Funcionam com nossos prendedores de chupeta.
        <br><br>
        Excelente para o auxílio no desenvolvimento da dentição do seu bebê.
        <br><br>
        <strong>Material Mordedor: Madeira natural e silicone</strong>
        <br>
        <strong>Quantidade: 1</strong>
        <br>
        <strong>Tipo: Brinquedo mordedor</strong>
        <br>
        <strong>Segurança: Livre de Latex e BPA</strong>
        <br>
        <strong>Idade: 0-2 anos</strong>
        <br><br>

        Produto importado!
        <br><br>

        IMPORTANTE: Todos os brinquedos são feitos de madeira natural e silicone 100% seguro para os bebês e crianças.
        <br><br>

        Como o trabalhamos com madeira natural, pode conter variação de tonalidade e forma entre as peças.
      </p>
      <hr>
      <div class="avaliacao">
        <h3>
    ...
    <div class="campo2">
      <h1>Mordedor infantil raposinha madeira</h1>
      <h2>R$75,00</h2>
      <form method="post">
        ...
        <input class="checkboxTamanhoP separar" type="radio" name="cor" value="laranja" />Laranja

        <div>
          <br>
          <p class="msgEstoque">Estoque Disponível: 15 unidades disponíveis</p>
        </div>
        <a href="https://mpago.la/2DV3zdw"><input type="submit" name="btnSubmiti" value="COMPRAR AGORA" class="botao comprar"></a>
