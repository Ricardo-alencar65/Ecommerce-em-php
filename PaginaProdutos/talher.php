...
if (isset($_POST['cor'])) {
  ...
  $sql_code = "UPDATE `variaveis` SET `qnt_estoque` = `qnt_estoque`-1 WHERE `variaveis`.`cor` = '$cor' and `id_produto` = '6'; ";
  $sql_query = $mysqli->query($sql_code) or die("Falha na execução do código SQL: " . $mysqli->error);
  $sql_code2 = "INSERT INTO `pedidos` (`id_cliente`, `id_produto`, `data_entrega`, `quantidade`) VALUES ('$_SESSION[id_cliente]', '6', '' , '1') ";
  ...
  <main class="main">
    <div class="campo1">
      <div class="bordaProduto">
        <img class="imgProduto" src="http://localhost/ecommerce/img/talherSilicone.jpg" alt="Imagem do produto" /><br />
      </div>
      ...
      <p class="infoProduto sobreProduto">
        <strong>Material:</strong> Silicone  e madeira 
        <br>
        <strong>Segurança:</strong> Livre de Latex, BPA, PVC, Ftalato e Nitrosamina
        <br><br>
        <strong>Kit:</strong> Garfo e colher
      </p>
      <hr>
      <div class="avaliacao">
        <h3>
    ...
    <div class="campo2">
      <h1>Kit talheres de silicone</h1>
      <h2>R$75,00</h2>
      <form method="post">
        ...
        <a href="https://mpago.la/1oztkML"><input type="submit" name="btnSubmiti" value="COMPRAR AGORA" class="botao comprar"></a>
